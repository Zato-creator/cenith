...
public class DialogoManager : Singleton<DialogoManager>
{
    ...
    private void Update()
    {
        ...
        if (Input.GetKeyDown(KeyCode.Space))
        {
            ...
            if (NPCDisponible.Dialogo.ContineinteraccionExtra)
            {
    ...
    private void ConfigurarPanel(NPCDialogo npcDialogo)
    {
        ...
        MostrarTextoConAmimacion(npcDialogo.Saludo);
    }
    ...
    private void ContinuarDialogo()
    {
        ...
        if (dialogosSecuencia.Count == 0)
        {
            ...
            MostrarTextoConAmimacion(despedida);
            despedidaMostrada = true;
            return;
        }

        string siguienteDialogo = dialogosSecuencia.Dequeue();
        MostrarTextoConAmimacion(siguienteDialogo);
    }
    ...
    private void MostrarTextoConAmimacion(string oracion)
    {
